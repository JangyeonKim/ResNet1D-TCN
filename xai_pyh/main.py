...
def load_args(default_config=None):
    parser = argparse.ArgumentParser(description='Pytorch XAI ')
    # -- dataset config
    ...
    parser.add_argument('--modality', default='raw_audio', choices=['video', 'raw_audio'], help='choose the modality')
    # -- directory
    parser.add_argument('--data-dir', default='/home/nas4/user/yh/xai_pyh/datasets/audio_data/', help='Loaded data directory')
    parser.add_argument('--label-path', type=str, default='/home/nas4/user/yh/xai_pyh/datasets/Label_List.txt', help='Path to txt file with labels')
    parser.add_argument('--annonation-direc', default='/home/nas/DB/[DB]_LIPREADING/LRW/lipread_mp4', help='Loaded data directory')
    # -- model config
    ...
    parser.add_argument('--optimizer',type=str, default='adamw', choices = ['adam','sgd','adamw','rmsprop'])
    ...
    # -- other vars
    parser.add_argument('--interval', default=25, type=int, help='display interval')
    parser.add_argument('--workers', default=32, type=int, help='number of data loading workers')
    # paths
    parser.add_argument('--logging-dir', type=str, default='./train', help = 'path to the directory in which to save the log file')
...
def main():
    ...
    '''
    ## FLOPs, Parameter print_v2
    import torchinfo
    print(torchinfo.summary(model))
    from ptflops import get_model_complexity_info
    macs, params = get_model_complexity_info(model, (1,29,88,88), as_strings=True, print_per_layer_stat=True, verbose=True)
    print('{:<30}  {:<8}'.format('Computational complexity: ', macs))
    print('{:<30}  {:<8}'.format('Number of parameters: ', params))
    sys.exit()

    
    ## FLOPs, Parameter print_v1
    print("parameter")
    import torchinfo
    print(torchinfo.summary(model))
    print("FLOPs")
    from thop import profile
    x = torch.rand(1,1,29,88,88).cuda()
    ...
    ###
    #args.model_path = '/home/yh/Lipreading_using_Temporal_Convolutional_Networks/train_logs/tcn/2022-05-23T15:55:52/ckpt.pth.tar'
    ###
    if args.model_path:
