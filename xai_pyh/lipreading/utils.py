...
# Cost time : 마지막 1배치 계산 시간, # (  )s : 1배치당 계산 소요시간 평균, Data time : 학습 마지막 배치 가져오는 시간, (  )s : 1배치당 데이터 가져오는 시간 평균
# Instances prer second : 1초당 계산되는 frame 수 요약 -> 이 지표 기준으로 실제 inference 시간 비교하면 된다.
