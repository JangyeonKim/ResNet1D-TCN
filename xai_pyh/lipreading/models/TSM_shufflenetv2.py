...
class InvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, benchmodel):
        ...
        if self.benchmodel == 1:
            ...
            #print('benchmodel!=1', inp) -> 24, 116, 232
            self.banch2 = nn.Sequential(
                # pw
                nn.Conv2d(inp, oup_inc, 1, 1, 0, bias=False),
                nn.BatchNorm2d(oup_inc),
    ...
    def forward(self, x):
        ...
        if 1==self.benchmodel:
            ...
            x2 = shift(x2, n_segment = batch, fold_div=4,inplace=False) # TSM
            ...
            #print(batch)
            x_shift = shift(x,n_segment = batch,fold_div=4,inplace=False) # TSM
            out = self._concat(self.banch1(x_shift), self.banch2(x_shift))
...
class ShuffleNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=2.):
        ...
        for idxstage in range(len(self.stage_repeats)):
            ...
            # output_channel(width_mult==1.0) = (index=2,3,4) 116,232,464
